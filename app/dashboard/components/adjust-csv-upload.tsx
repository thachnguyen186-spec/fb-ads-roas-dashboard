  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        />
        {parsing ? (
          <p className="text-sm text-gray-500">Reading CSV…</p>
        ) : file ? (
          <div>
          ...
          <div>
            <p className="text-sm text-gray-500">Drop Adjust CSV here or click to browse</p>
      ...
      {/* App filter (only shown when multiple apps present) */}
      {apps.length > 1 && (
        <div>
          <label className="block text-xs font-medium text-gray-600 mb-1">
            Filter by app <span className="text-gray-400 font-normal">(optional)</span>
          </label>
          <select
            value={selectedApp}
